# Mouse Painter
Mouse Painter is a demo desktop application that provides functionality similar to that provided throgh the known Painter application.  

The app is developed to work in bare machine without an operating system; it directly interacts with the hardware drivers. The app is developed entirely in x86 assembly language.  

The app provide the following functionalities:  
1- Freehand drawing.  
2- Circles drawing.  
3- rectangles drawing.  
4- Straight Lines drawing.  
5- Changing the drawing color.  
